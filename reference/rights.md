# Rights, Trademarks & Licensing

## Original TeleGrafix rights
...
TeleGrafix's stated policy, from 1.54 specification (preserved verbatim in [1.5x/text/RIPScrip-1.54.txt](../version/1.54/text/RIPScrip-1.54.txt)):
...
TeleGrafix faded away rather than formally winding down - its last documented activity was July 2001, and the telegrafix.com domain expired on June 18, 2006. Its president/CEO **Pat Clawson died in 2015** (see [history.md](../version/history.md)). No acquisition, assignment, or transfer of the RIPscrip copyrights or trademarks has ever surfaced, and no successor-in-interest is known.

The practical result: the common-law trademark claims have almost certainly lapsed through decades of non-use, while the copyrights on the 1992-1997 works technically persist - held by whatever entity or heirs succeeded the defunct corporation, with no party on record positioned to exercise them. The work is, in every practical sense, **in limbo**.

The original materials are preserved here for **historical, archival, and interoperability purposes**. Should a legitimate successor-in-interest come forward, this repository will gladly cooperate on attribution or disposition of the original texts.
...
- The Markdown editions under `version/<v>/ripscrip/` are conversions and (for 3.x) reconstructions of TeleGrafix-authored material. The editorial contribution of this repository to those documents is dedicated to the public domain via CC0; to the extent the underlying TeleGrafix text remains protected, it is reproduced here under the preservation rationale above.
- CC0 does not waive trademark rights (see [LICENSE](../LICENSE) §4a) - the TeleGrafix marks, to whatever extent they survive, are not this repository's to waive.
- Nothing here is legal advice; it is a good-faith statement of provenance and intent.
