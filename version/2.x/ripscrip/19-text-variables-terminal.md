...
These text variables return information on, or manipulate a mode of operation of the RIPscrip terminal. *(v2.A4)*
...
*External Application Call (x=0-9)*
...
This command is obsolete.  You should be using the [`$APP(appno)$`](#app) command as it is more general in nature.  Other than that, the new APP command performs the exact same operation.  If you need to pass custom arguments to the external application, then use the more generic `$APP(appno)$` command instead. *(v2.A1)*
...
*Set/return baud rate emulation*
...
*Added in RIPscrip v2.A1; revised in v2.A2.*
...
*Disables screen refresh expression*
...
*Enable/disable a software option*

*Added in RIPscrip v2.A3; revised in v2.A4.*
...
This command allows you to turn on or turn off a specific system option in the RIPscrip application.  The possible options that can be enabled or disabled are specified with the \<name\> parameter as follows: *(v2.A4)*
...
*Forces terminal to Transmit Refresh*
...
These text variables reset particular aspects of the RIPscrip environment. *(v2.A4)*

### $RESET$

*Perform a reset operation*

*Revised in RIPscrip v2.A4.*
