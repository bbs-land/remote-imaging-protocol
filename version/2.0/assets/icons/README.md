...
A uniform "GAL\_" set of BBS-service gallery icons, 1,070 bytes each: `GAL_DATA.BMP`, `GAL_DOLR.BMP`, `GAL_EWRT.BMP`, `GAL_FILE.BMP`, `GAL_GAME.BMP`, `GAL_INFO.BMP`, `GAL_MAIL.BMP`, `GAL_NEWS.BMP`.
