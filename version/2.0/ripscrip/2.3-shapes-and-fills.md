...
[Rectangles & bars](#rip_rectangle) · [Rounded rectangles](#rip_rounded_rect) · [Filled circles & ovals](#rip_filled_circle) · [Pie slices](#rip_pie_slice) · [Polygons & poly-beziers](#rip_polygon) · [Fill styles & patterns](#rip_fill_style) · [Borders](#rip_set_border) · [RIP_FILL - removed in 2.x](#rip_fill)
...
_See [errata.md](errata.md#rip_fill-removed-and-never-reliable) for the evidence behind the removal and the command's unreliability in the 1.5x era._
