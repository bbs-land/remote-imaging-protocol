...
This page covers the curved outline primitives: circles, ellipses (ovals), circular and elliptical arcs, and bezier curves. All draw in the current drawing color and honor line thickness; none of them (except the bezier) honor line patterns. The filled counterparts — filled ovals and pie slices — are grouped with the other filled shapes in [2.3 Shapes & Fills](2.3-shapes-and-fills.md). Arc angles are measured in degrees, 0 at the 3 o'clock position, increasing counterclockwise to 360; the circle-family commands understand the 640×350 pixel aspect ratio (see [1.2 Math & Coordinates](1.2-math-and-coordinates.md#aspect-ratio)).
