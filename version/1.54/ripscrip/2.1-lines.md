...
This page covers the straight-line drawing primitives — single pixels, lines, and multi-segment poly-lines — together with the line-style state (pattern and thickness) they draw with. All of these draw in the current drawing color ([RIP_COLOR](2.0-colors-and-attributes.md#rip_color)), honor the current [write mode](2.0-colors-and-attributes.md#rip_write_mode), and are clipped to the [viewport](../../GLOSSARY.md) ([RIP_VIEWPORT](1.3-world-view-virtual-canvas.md#rip_viewport)). Curved outlines are in [2.2 Curves](2.2-curves.md); closed and filled shapes are in [2.3 Shapes & Fills](2.3-shapes-and-fills.md).
