...
This page covers graphics-window text: positioning the drawing cursor, drawing text strings in the current font/color, and selecting among the eleven font styles (one bitmap, ten scalable stroked fonts), their sizes and directions. This is graphics text drawn into the graphics window — distinct from the [text window](1.4-terminal-ansi-view.md)'s TTY output. Formatted multi-line text blocks are covered in [3.1 Text Regions](3.1-text-regions.md). The underlying font file formats are implementer material: [BGI stroked fonts](../techspecs/3.1-bgi-stroked-fonts.md) and [bitmap fonts](../techspecs/3.2-bitmap-fonts.md).
