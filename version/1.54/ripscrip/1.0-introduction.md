...
This page introduces RIPscrip 1.54 — what the language is, why it exists, its design goals, and the product and licensing context of its creator, TeleGrafix Communications. It is the starting point for content creators; the rest of chapter 1 covers the [command syntax](1.1-protocol-and-command-hierarchy.md), the [number system and coordinate space](1.2-math-and-coordinates.md), and the [graphics](1.3-world-view-virtual-canvas.md) and [text](1.4-terminal-ansi-view.md) display model.
