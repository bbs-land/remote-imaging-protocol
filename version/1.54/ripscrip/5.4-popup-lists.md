...
This page covers Pop-Up Pick Lists — host-defined selection lists that pop up on the terminal and insert the chosen entry's text into the [host command](5.0-host-commands.md) being built. Lists can be used anywhere a [text variable](5.1-text-variables.md) can.
