...
| 256-color / 24-bit SGR (`38;5`, `38;2`, `CSI … t`) | Yes | Yes | **None at the ANSI layer.** 1.54 Appendix B documents only classic attribute SGR. RIPterm 2.x's 256-color/direct-RGB support is RIPscrip-command-level (SVGA palette commands — see [2.x techspecs](../../2.x/techspecs/README.md)), not an SGR extension |
