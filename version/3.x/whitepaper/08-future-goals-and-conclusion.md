...
## 4.1 International Language Support
...
## 4.3 Compressed, Streaming Audio

Another popular request for RIPscrip is a formal, compressed [audio](../../2.x/ripscrip/06-color-audio-text.md) format that is suitable for playing voice or music-grade audio over a streaming network connection (e.g., 14.4 modem, ethernet, TCP/IP, etc.). Currently, a number of audio formats are under consideration for possible implementation including APEG, CELP and several others.

## 4.4 Integrated GUI Environment
...
## 4.6 Document Oriented Interface
...
## 4.7 Hyper-Text Markup Language (HTML)
