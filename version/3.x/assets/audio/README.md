...
RIPscrip 3.0 plays background WAV audio via
[RIP_PLAY_AUDIO](../../ripscrip/11-level-1-commands.md#rip_play_audio) and the
[`$)FILE.WAV$` playback prefix](../../ripscrip/15-local-playback-popup-lists.md).
...
This directory mirrors that reality: it exists to hold any 3.x-era audio
files recovered in the future, and is empty because none were distributed.
See the [research notes](../../research/riptel-help-extraction.md) for the
