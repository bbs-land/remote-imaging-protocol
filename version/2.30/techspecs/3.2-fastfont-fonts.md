...
Both generations are preserved byte-exact in [`version/2.30/assets/fonts/`](../../2.30/assets/fonts/README.md); prior partial decodes are in the [3.x file-formats page](../../3.1/ripscrip/6.1-content-file-roles.md#fonts-are-not-content-files) and the [RIPtel binary triage §1](../../3.1/research/riptel-binary-formats.md), which this page supersedes for the base format.
