...
This page covers the curved outline primitives: circles, ellipses (ovals), circular and elliptical arcs, and the bezier family — including the 2.x poly-bezier additions that chain line and curve segments into one object. All draw in the current drawing color and honor line thickness; the circle/oval/arc family does not honor line patterns, while the bezier family does. Arc angles are in degrees, 0 at the 3 o'clock position, increasing counterclockwise to 360. Under 2.x these primitives also honor XOR and the other write modes (a 1.54 limitation lifted — see [2.0 Color Modes & Palettes](2.0-color-modes-and-palettes.md#rip_write_mode)). The filled counterparts (filled circle/oval, pie slices, filled poly-bezier) are in [2.3 Shapes & Fills](2.3-shapes-and-fills.md). The 1.54 record of the base commands is [2.2 in the v1.54 reference](../../1.54/ripscrip/2.2-curves.md).
