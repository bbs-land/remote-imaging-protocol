...
_The 1.54 record of this material is [1.1 in the v1.54 reference](../../1.54/ripscrip/1.1-protocol-and-command-hierarchy.md); the 2.x syntax is a superset - rules 10 (parameter shortening), 12 (SOH/STX mid-line starts), 14 (quoting host-command characters), 15 (comments) and 16 (corrupt-command recovery) are the 2.x additions._
