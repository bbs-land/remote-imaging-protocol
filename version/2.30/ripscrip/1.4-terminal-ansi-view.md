...
_Editor's note: text windows support ANSI and VT-102 screen control; the terminal-emulation baseline is the [ANSI/VT support reference](../../baseline/techspecs/ansi-vt-support.md)._
