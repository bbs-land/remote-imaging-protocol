...
This page covers Pop-Up Pick Lists — host-defined selection lists that pop up on the terminal and insert the chosen entry's text into the [host command](5.0-host-commands.md) being built. Lists can be used anywhere a [text variable](5.1-text-variables.md) can. The 1.54 record is [5.4 in the v1.54 reference](../../1.54/ripscrip/5.4-popup-lists.md); 2.x raises the entry limit from 20 to 64 _(v2.A1)_.
