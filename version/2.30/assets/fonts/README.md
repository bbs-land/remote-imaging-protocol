...
These five families are the **direct ancestors of RIPscrip 3.x's `.RFF` fonts** — and the recovered RIPterm 2.30 install pins the transition to **RIPterm 2.30, not RIPtel**: 2.30 replaces all five `.FF1` files with `.RFF` conversions dated April 1997 (see the next section). See the [3.x fonts README](../../../3.1/assets/fonts/README.md) and the [3.x file-formats page](../../../3.1/ripscrip/6.1-content-file-roles.md#fonts-are-not-content-files) for the decoded header/style-record layout.
