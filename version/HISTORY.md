...
| RIPterm Test Drive 2.00.01 | 1995 | Crippleware evaluation build of RIPterm Pro 2.0 (self-extractor banner "RIPterm Test Drive v2.00.01 … Copyright (c) 1992-95"; [preserved download](DOWNLOADS.md)) |
| RIPterm Pro Test Drive 2.10.00 / 2.11.00 | Aug 13 / Sep 7, 1995 | Test Drive line continued — the "RIPterm 2.1" long assumed never to have existed. Documented by the v2.11.00 README.DOC changelog ([preserved download](DOWNLOADS.md)); 2.11.00's listed changes: JPEG display ~20% faster, Sound Blaster 16/ASP-16/AWE-32 detection fixes, keystroke-macro saving fix, and button world-coordinate/font-size corrections |
