...
| RIPterm 2.20.00 / RIP-2 launch | Nov 19 / [Dec 20, 1995](https://groups.google.com/g/nz.comp/c/uqvFCUynE5w) | "RIP-2 Internet Multimedia": RIPterm v2.2 shareware (Windows installer, DOS executable), RIPaint-2, RIPweb — "integrates JPEG photographic images, complex SVGA graphics, text and digital WAV sound" |
...
| RIPterm 2.3 "Evaluation Edition" | [Oct 27, 1997](https://web.archive.org/web/20000919190158/http://www.telegrafix.com:80/products/ripterm/) | Final RIPterm; distributed via a Windows (Win16) installer; primarily maintenance (OS/2 and Windows DOS-box compatibility) |
...
- **RIPterm 2.2/2.3 were Windows releases with DOS executables.** RIPterm 2.0 was a DOS install (two-disk set); 2.2 and 2.3 were distributed and installed as Windows products — the 2.30 shareware installer is a Win16 executable, and 2.3 added a Windows setup/icon installer — but the client executable itself remained a DOS program (commonly run in a Windows DOS box); a Windows-native or Mac client never verifiably shipped.
