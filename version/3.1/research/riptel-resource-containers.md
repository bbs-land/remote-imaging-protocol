...
The embedded default palette matches the RIPscrip 2.x specified 256-color table byte-for-byte — corroboration recorded in the [2.x palette techspec](../../2.30/techspecs/2.0-canvas-palette-rgb.md).
