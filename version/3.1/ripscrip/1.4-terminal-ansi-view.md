...
_Where 1.54 had a single text window ([1.4 in the v1.54 reference](../../1.54/ripscrip/1.4-terminal-ansi-view.md)), 2.30/3.x allows up to 36, one current at a time._
