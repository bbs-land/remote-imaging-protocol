...
| Tag | Meaning |
| --- | --- |
| `2.00a4` | Documented in the RIPscrip 2.00 alpha 4 specification, which 3.x inherits (merged here from the [v2.30 reference](../../2.30/ripscrip/README.md)) |
...
- **1. Fundamentals**
  - **[1.0 Introduction](1.0-introduction.md)** - the 3.x generation, reconstruction status and evidence model, engine lineage from 2.30
