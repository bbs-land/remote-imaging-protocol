...
_Unlike [the 1.54 record](../../1.54/ripscrip/2.2-curves.md), these primitives honor XOR and the other [write modes](2.0-color-modes-and-palettes.md#rip_write_mode) - a 1.54 limitation lifted in 2.30._
