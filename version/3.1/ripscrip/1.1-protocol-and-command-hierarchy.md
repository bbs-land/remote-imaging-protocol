...
_The 3.x syntax is the 2.30 syntax verbatim - the inherited rules below are the published 2.00a4 language definition - overlaid here with the byte-exact behavior of the shipping 3.0.7 driver (observed through the RIPtel corpus) and SyncTERM's 3.0 parser._
