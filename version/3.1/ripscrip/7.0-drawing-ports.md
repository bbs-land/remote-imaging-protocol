...
[Drawing ports](../../GLOSSARY.md) - the fundamental drawing abstraction the 3.0 engine inherits from 2.30 and, by corpus evidence, the workhorse of shipped 3.x content: screen regions and offscreen (clipboard) surfaces, each with its own coordinate origin and [viewport](../../GLOSSARY.md).
