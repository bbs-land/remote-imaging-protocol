...
_The 16-color 1.54 model this extends is [2.0 in the v1.54 reference](../../1.54/ripscrip/2.0-colors-and-attributes.md); renderer-side palette/DAC scaling details are in the [2.30 canvas, palette & RGB techspec](../../2.30/techspecs/2.0-canvas-palette-rgb.md)._
...
In RIPscrip 1.54 these raster operations applied only to simple lines; under 2.x and 3.x they apply to all primitives.
