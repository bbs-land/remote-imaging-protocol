...
_The 1.54 record is [4.0 in the v1.54 reference](../../1.54/ripscrip/4.0-images-and-icons.md); the 2.30 record is [4.0 in the v2.30 reference](../../2.30/ripscrip/4.0-icons-and-bitmaps.md). Byte-level format is in the [v2.30 icon formats techspec](../../2.30/techspecs/3.0-icon-formats.md), unchanged in 3.x, with the RIPtel file census in the [binary-formats research](../../3.1/research/riptel-binary-formats.md)._
