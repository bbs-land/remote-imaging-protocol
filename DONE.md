...
**2.30 fidelity audit + ERRATA restructure (2026-08-10).** Fourteen read-only audits covered all 43 pages of `version/2.30/{ripscrip,techspecs}/`, then three opus reviewers adversarially re-verified every defect **and its proposed fix** before anything was edited.
